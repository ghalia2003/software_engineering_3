            ...
            children: [
              ...
              OtpTextField(
                ...
                borderColor: const Color(
                  0xFFE0E0E0,
                ), //هذا اللون يظهر عندما الخانة غير مفعّلة (غير مركّز عليها)
                focusedBorderColor: ColorsTheme.primaryBlue, //اللون الذي يظهر عندما المستخدم يضغط على الخانة
                ...
                listener: (context, state) {
                  ...
                  if (state is otrpSuccess) {
                    ScaffoldMessenger.of(
                     ...
                     context.go(AppRouter.SucessOtppage);
                  }
                },
